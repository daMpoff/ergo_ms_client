...
import DatasetTooltip from '@/modules/bi/Charts/components/DatasetsTooltip.vue'
import DatasetIndicators from '@/modules/bi/Charts/components/DatasetIndicators.vue'
import DatasetMeasures from '@/modules/bi/Charts/components/DatasetMeasures.vue'
import DatasetSettings from '@/modules/bi/Charts/components/DatasetSettings.vue'
import ChartFields from '@/modules/bi/Charts/ChartFields.vue'
import ChartArea from '@/modules/bi/Charts/ChartArea.vue'
import ChartNameDialog from '@/modules/bi/Charts/components/ChartNameDialog.vue'

import { useRouter, useRoute } from 'vue-router'
import { chartSettingsConfig } from '@/modules/bi/MainPage/Sidebar/components/js/chartSettingsConfig.js'
import chartService from '@/modules/bi/MainPage/Sidebar/components/js/chartService.js'
