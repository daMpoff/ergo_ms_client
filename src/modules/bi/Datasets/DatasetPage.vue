...
import { useDatasetState } from '@/modules/bi/Datasets/components/js/useDatasetState'
import { useDatasetActions } from '@/modules/bi/Datasets/components/js/useDatasetActions'

// Импортируем компоненты
import DatasetHeader from '@/modules/bi/Datasets/DatasetHeader.vue'
import DatasetToolbar from '@/modules/bi/Datasets/DatasetToolbar.vue'
import DatasetMainContent from '@/modules/bi/Datasets/Sources/DatasetMainContent.vue'
import DatasetFooter from '@/modules/bi/Datasets/DatasetFooter.vue'
import DatasetModals from '@/modules/bi/Datasets/Sources/DatasetModals.vue'
