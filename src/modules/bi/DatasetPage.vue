...
import { useDatasetState } from '@/modules/bi/composables/useDatasetState'
import { useDatasetActions } from '@/modules/bi/composables/useDatasetActions'

// Импортируем компоненты
import DatasetHeader from '@/modules/bi/components/DatasetPreview/DatasetHeader.vue'
import DatasetToolbar from '@/modules/bi/components/DatasetPreview/DatasetToolbar.vue'
import DatasetMainContent from '@/modules/bi/components/DatasetPreview/DatasetMainContent.vue'
import DatasetFooter from '@/modules/bi/components/DatasetPreview/DatasetFooter.vue'
import DatasetModals from '@/modules/bi/components/DatasetPreview/DatasetModals.vue'
