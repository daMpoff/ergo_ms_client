...
import { isDatasetSidebarOpen } from '@/modules/bi/MainPage/Sidebar/components/js/useSidebarStore'
import { useRouter } from 'vue-router'
import SimpleTableDataSet from '@/modules/bi/MainPage/Sidebar/components/SimpleTableDataSet.vue'
