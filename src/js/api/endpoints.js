export const endpoints = {
    ...
    project_ed: {
        ...
        event_blocks: {
            list: 'project_ed/project-ed/event-blocks/',
            create: 'project_ed/project-ed/event-blocks/',
            detail: (id) => `project_ed/project-ed/event-blocks/${id}/`,
            update: (id) => `project_ed/project-ed/event-blocks/${id}/`,
            patch: (id) => `project_ed/project-ed/event-blocks/${id}/`,
            delete: (id) => `project_ed/project-ed/event-blocks/${id}/safe_delete/`,
            updateOrder: (id) => `project_ed/project-ed/event-blocks/${id}/update_order/`,
            events: (id) => `project_ed/project-ed/event-blocks/${id}/events/`,
        },
        events: {
            list: 'project_ed/project-ed/events/',
            create: 'project_ed/project-ed/events/',
            detail: (id) => `project_ed/project-ed/events/${id}/`,
            update: (id) => `project_ed/project-ed/events/${id}/`,
            patch: (id) => `project_ed/project-ed/events/${id}/`,
            delete: (id) => `project_ed/project-ed/events/${id}/safe_delete/`,
            updateOrder: (id) => `project_ed/project-ed/events/${id}/update_order/`,
        },
    },
};
