...
const iconPath = computed(() => {
  ...
  switch (ext) {
    ...
    case 'xlsx':
    case 'xls': return new URL('@/core/bi/assets/icons/xlsx.svg', import.meta.url).href
    case 'txt': return new URL('@/core/bi/assets/icons/txt.svg', import.meta.url).href
    default: return new URL('@/core/bi/assets/icons/folder_windows_style.svg', import.meta.url).href
  }
})
