...
<template>
  <form @submit.prevent="submitForm" novalidate>
   ...
   <GroupsChangingLists :list="groups" @changeGroups="changes" :username="user" ref="groupsChangingListsRef" />
   <br />
   <PermissionsChangingList :list="permissions" :username="user" @changePermissions="changes" ref="permissionsChangingListsRef" />
