  ...
  <div class="row">
    <div class="card-item">
      <div class="stats-card">
        ...
        <div class="stats-info">
          ...
          <div class="stats-text">Мои курсы</div>
        </div>
      </div>
    </div>
    ...
    <div class="card-item">
      <div class="stats-card">
        ...
        <div class="stats-info">
          <div class="stats-number">{{ stats?.submitted_assignments || 0 }}</div>
          <div class="stats-text">Завершено заданий</div>
        </div>
      </div>
    </div>
    ...
    <div class="card-item">
      <div class="stats-card">
        ...
        <div class="stats-info">
          <div class="stats-number">{{ stats?.average_grade?.toFixed(1) || 0 }}</div>
          <div class="stats-text">Средний балл</div>
        </div>
      </div>
    </div>
  </div>
