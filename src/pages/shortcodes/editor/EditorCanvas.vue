    ...
    <div class="position-relative mb-4">
        <div class="card h-100 shadow-sm">
            ...
            <div class="card-body p-0 position-relative">
                <Draggable v-model="internalTree" :external-data-handler="externalDataHandler"
                    :on-external-drag-over="() => true" tree-line value-key="uid"
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <button class="btn btn-sm btn-outline-secondary" @click="$emit('open-settings', node)"
                                    title="Настроить компонент">⚙️</button>
                            </div>
                        </div>
                    </template>
                </Draggable>
                <div v-if="internalTree.length === 0"
