    ...
    <div class="accordion-item">
      <h2 class="accordion-header" id="headingVisual">
        <button class="accordion-button bg-light" type="button" data-bs-toggle="collapse"
          data-bs-target="#collapseVisual" aria-expanded="true" aria-controls="collapseVisual">
          🎨 Визуальные настройки
        </button>
      </h2>
        ...
        <div class="accordion-body">
          ...
          <div class="mb-3">
            ...
            <div class="btn-group flex-wrap">
              <button v-for="size in fontSizes" :key="size" type="button" class="btn btn-outline-primary m-1"
                :class="{ active: hasClass(size) }" @click="toggleClass(size, fontSizes)">
                {{ size }}
              </button>
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="btn-group flex-wrap">
              <button v-for="color in bgColors" :key="color" type="button" class="btn m-1"
          ...
          <div class="mb-3">
            ...
            <div class="btn-group flex-wrap">
              <button v-for="color in textColors" :key="color" type="button" class="btn m-1"
    ...
    <div class="accordion-item">
      <h2 class="accordion-header" id="headingPadding">
        <button class="accordion-button collapsed bg-light" type="button" data-bs-toggle="collapse"
          data-bs-target="#collapsePadding" aria-expanded="false" aria-controls="collapsePadding">
      ...
      <div id="collapsePadding" class="accordion-collapse collapse" aria-labelledby="headingPadding">
        <div class="accordion-body">
          <div v-for="prefix in paddingKeys" :key="prefix" class="mb-3">
            ...
            <input type="range" min="0" max="5" v-model.number="spacingValues[prefix]"
              @input="applySpacing(prefix, spacingValues[prefix])" class="form-range" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div id="collapseExtra" class="accordion-collapse collapse" aria-labelledby="headingExtra">
        <div class="accordion-body">
          <div class="form-check mb-3">
            <input class="form-check-input" type="checkbox" id="toggleVisibility" :checked="hasClass('d-none')"
...
watch(() => component.value.class_list, (list) => {
...
function hasClass(cls) {
  return Array.isArray(component.value.class_list) &&
    component.value.class_list.includes(cls)
}

// Включить/выключить класс из группы
function toggleClass(targetClass, classGroup) {
  const list = Array.isArray(component.value.class_list)
